...
- _Низкое удержание пользователей_ → Фокус на onboarding и первую пользу в течение 5 минут
- _Конкуренция с Splitwise_ → Акцент на российскую специфику и простоту
